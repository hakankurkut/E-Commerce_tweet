...
tweets = [
    {
        'post_id': 0,
        'tweet': 'Just threw the ring into the volcano with the ring!!!' ,
...
def posts():
    ...
    # when form is submitted append to post listm re-render posts page
...
def title():
    ...
    # when form submitted, redirect to home page, and pass title to change what the h1 tag says
    if form.validate_on_submit():
